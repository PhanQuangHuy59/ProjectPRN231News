...
namespace WebNewsAPIs.Controllers
{
    ...
    public class CategoriesArticlesController : ControllerBase
    {
        ...
        //[HttpPost("AddNewCategoriesArticle")]
        //public IActionResult AddNewCategoriesArticle(AddCategoriesArticleDto? addCategoriesArticleDto)
        //{
        //    if(addCategoriesArticleDto == null)
        //    {
        //        return BadRequest();
        //    }
        //    string[] includes = new string[]
